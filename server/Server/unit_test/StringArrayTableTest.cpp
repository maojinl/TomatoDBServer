...
class StringArrayTableTest : public testing::Test {
public:
...
TEST_F(StringArrayTableTest, StringArrayTable_1Layer) {
...
TEST_F(StringArrayTableTest, StringArrayTable_2Layers) {
	StringArrayTable sat;
...
TEST_F(StringArrayTableTest, StringArrayTable_3Layers) {
	StringArrayTable sat;
...
TEST_F(StringArrayTableTest, WriteStringArrayTable_1Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1);
...
TEST_F(StringArrayTableTest, WriteStringArrayTable_2Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1, &vvs1);
...
TEST_F(StringArrayTableTest, WriteStringArrayTable_3Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1, &vvs1, &vvvs1);
...
TEST_F(StringArrayTableTest, DeleteNode_3Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1, &vvs1, &vvvs1);
...
TEST_F(StringArrayTableTest, WriteEmtyStringArrayTable_3Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1, &vvs1, &vvvs1);
...
TEST_F(StringArrayTableTest, AppendStringArrayTable_1Layer) {
	StringArrayTable sat;
	sat.InitWithArrays(&vs1);
	ASSERT_EQ(1, sat.GetLayer());
	ASSERT_EQ(33, sat.GetLength());
...
TEST_F(StringArrayTableTest, AddLinks) {
...
TEST_F(StringArrayTableTest, JsonWriterTest) {
...
TEST_F(StringArrayTableTest, ArrayTableWriterTest) {
