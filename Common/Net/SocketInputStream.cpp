...
//{
//	INT ValueType = 0;
//	Readex((CHAR*)&ValueType,1);
//	switch(ValueType)
//	{
//	case T_INT8 : 		Readex( buf, 1 ) ;		break;
//	case T_INT16:		Readex( buf, 2 ) ;		break;
//	case T_INT32:		Readex( buf, 4 ) ;		break;
//	case T_INT64:
//	case T_FLOAT64:		Readex( buf, 8 ) ;		break;
//	case T_STRING:
//		{
//			USHORT strLen = 0 ;
//			Readex((CHAR*)&strLen,sizeof(USHORT));
//			Readex( buf, strLen ) ;
//			break;
//		}
//	case T_LIST:
...
//
//}
//UINT SocketInputStream::Readex( CHAR* buf, UINT len ) 
UINT SocketInputStream::Read( CHAR* buf, UINT len ) 
{
__ENTER_FUNCTION_FOXNET
