...
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
INT EnvFileAPI::open_ex(const CHAR* filename, INT flags) {
...
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
INT EnvFileAPI::open_ex(const CHAR* filename, INT flags, INT mode) {
	__ENTER_FUNCTION_FOXNET
...
//////////////////////////////////////////////////////////////////////
//
// UINT EnvFileAPI::read_ex ( INT fd , VOID * buf , UINT len ) 
//
//
...
//////////////////////////////////////////////////////////////////////
//
// UINT EnvFileAPI::write_ex ( INT fd , VOID * buf , UINT len ) 
//
//
...
//
//////////////////////////////////////////////////////////////////////
UINT EnvFileAPI::write_ex ( INT fd , const VOID * buf , UINT len ) 
{
	__ENTER_FUNCTION_FOXNET
...
//////////////////////////////////////////////////////////////////////
//
// VOID EnvFileAPI::close_ex ( INT fd ) 
//
//
...
//////////////////////////////////////////////////////////////////////
//
// INT EnvFileAPI::fcntl_ex ( INT fd , INT cmd ) 
//
//
// Parameters
//     fd  - file descriptor
...
//////////////////////////////////////////////////////////////////////
//
// INT EnvFileAPI::fcntl_ex ( INT fd , INT cmd , LONG arg ) 
//
//
// Parameters
//     fd  - file descriptor
...
//
//////////////////////////////////////////////////////////////////////
BOOL EnvFileAPI::getfilenonblocking_ex ( INT fd ) 
{
	__ENTER_FUNCTION_FOXNET
...
//
//////////////////////////////////////////////////////////////////////
VOID EnvFileAPI::setfilenonblocking_ex ( INT fd , BOOL on ) 
{
	__ENTER_FUNCTION_FOXNET
...
//////////////////////////////////////////////////////////////////////
//
// VOID EnvFileAPI::ioctl_ex ( INT fd , INT request , VOID * argp )
//
//
...
//////////////////////////////////////////////////////////////////////
//
// VOID EnvFileAPI::setfilenonblocking_ex2 ( INT fd , BOOL on )
//
//
...
//////////////////////////////////////////////////////////////////////
//
// UINT EnvFileAPI::available_ex ( INT fd )
//
//
...
//
//////////////////////////////////////////////////////////////////////
UINT EnvFileAPI::availablefile_ex ( INT fd )
{
	__ENTER_FUNCTION_FOXNET
...
//////////////////////////////////////////////////////////////////////
//
// LONG EnvFileAPI::lseek_ex ( INT fd , LONG offset , INT whence )
//
//
//////////////////////////////////////////////////////////////////////
LONG EnvFileAPI::lseek_ex ( INT fd , LONG offset , INT whence )
...
LONG EnvFileAPI::tell_ex( INT fd )
{
	__ENTER_FUNCTION_FOXNET
