...
//UINT SocketOutputStream::AddListNode( UINT len ) 
//{
//__ENTER_FUNCTION_FOXNET
//
//	TYPE_INDEX type_List = T_LIST;
//	Write_ex((CHAR*)(&type_List), 1);
//	Write_ex((CHAR*)(&len), 2);
//
//	return 3;
//
...
//UINT SocketOutputStream::Write( const CHAR* buf, UINT len ,TYPE_INDEX TypeIndex) 
//{
//__ENTER_FUNCTION_FOXNET
//	switch(TypeIndex)
//	{
...
//UINT SocketOutputStream::Write_ex( const CHAR* buf, UINT len ) 
